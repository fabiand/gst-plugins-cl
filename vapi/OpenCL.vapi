...
namespace OpenCL
{
    ...
    [Compact]
    [CCode (cname = "struct _cl_context", has_type_id = false, ref_function = "clRetainContext", unref_function = "clReleaseContext")]
    public class Context {
    }
    
    [Compact]
    [CCode (cname = "struct _cl_command_queue", has_type_id = false, ref_function = "clRetainCommandQueue", unref_function = "clReleaseCommandQueue")]
    public class CommandQueue {
    }
    
    [Compact]
    [CCode (cname = "struct _cl_mem", has_type_id = false, ref_function = "clRetainMemObject", unref_function = "clReleaseMemObject")]
    public class Mem {
    }
    
    [Compact]
    [CCode (cname = "struct _cl_kernel", has_type_id = false, ref_function = "clRetainKernel", unref_function = "clReleaseKernel")]
    public class Kernel {
    }
    
    [Compact]
    [CCode (cname = "struct _cl_program", has_type_id = false, ref_function = "clRetainProgram", unref_function = "clReleaseProgram")]
    public class Program {
    }
    
    [Compact]
    [CCode (cname = "struct _cl_event", has_type_id = false, ref_function = "clRetainEvent", unref_function = "clReleaseEvent")]
    public class Event {
    }
    
    [Compact]
    [CCode (cname = "struct _cl_sampler", has_type_id = false, ref_function = "clRetainSampler", unref_function = "clReleaseSampler")]
    public class Sampler {
    }
    
    [Compact]
    [CCode (cname = "struct _cl_image_format", has_type_id = false)]
...
public delegate void EventCallback(Event  event, 
                                   CommandExecutionStatus event_command_exec_status, 
                                   void*  user_data);
